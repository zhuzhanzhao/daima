...
echo -e "${yellow} “资料和联系方式：”
 "${red} "==============================================================" ${font}"
 "${yellow} CentOS7 X86_64《tiktok”无人值守循环推流直播搭建》  ${font}"
 "${red} 请确定此脚本目前是在screen窗口内运行的! ${font}"
 "${yellow} 作者：失落的梦 ${font}"
 "${yellow} 微信：Falltoher-1314 ${font}"
 "${yellow} qq： 1150315739 ${font}"
 "${yellow} 博客：https://www.vcxm789.asia ${font}"
 "${yellow} 博客：https://www.kehu33.asia ${font}"
 "${yellow} “开始安装选项设置：”
echo -e "${red} "==============================================================" ${font}"
