...
check_domain() {
  ...
  while [ "${real_ip}" != "${local_ip}" ]; do
    ...
    real_ip=$(ping "${domain}" -c 1 | sed '1{s/[^(]*(//;s/).*//;q}')
    read -rp "我已人工确认，本机Ip和域名绑定的IP一致，继续安装（Y/n）？（默认:y）" continue_install
...
install_caddy_service() {
  ...
  #  read -p "$(echo -e "${Info}邮箱输入正确吗（Y/n）？（默认）y")" Yn
  #  [[ -z ${Yn} ]] && Yn="y"
  #  while [[ ${Yn} != "Y" ]] && [[ ${Yn} != "y" ]]; do
...
${FUCHSIA}===================================================
${GREEN}1. 安装trojan+tls+nginx推荐
${FUCHSIA}===================================================
${GREEN}2. 安装trojan+tls+caddy
${FUCHSIA}===================================================
${GREEN}3. 安装vmess+tls+nginx推荐
${FUCHSIA}===================================================
${GREEN}4. 安装vmess+tls+caddy推荐
${FUCHSIA}===================================================
${GREEN}5. 安装vless+tls+nginxtuij
${FUCHSIA}===================================================
${GREEN}6. 安装vless+tls+caddy
${FUCHSIA}===================================================
${GREEN}7. 安装ssr+tls+caddy
${FUCHSIA}===================================================
${GREEN}8. 安装ssr+tls+nginx推荐
${FUCHSIA}===================================================
${GREEN}9. 卸载全部，系统回到初始状态
${FUCHSIA}===================================================
${GREEN}10. 安装BBR加速
${FUCHSIA}===================================================
${GREEN}0. 不好用，退出${NO_COLOR}"
