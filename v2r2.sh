...
bbrInstall() {
	echoContent red "\n=============================================================="
	echoContent green "BBR、DD脚本用的[失落的梦]的成熟作品请熟知"
...
menu() {
	cd "$HOME" || exit
	echoContent red "\n=============================================================="
	echoContent green "作者:失落的梦"
	echoContent green "当前版本:v21.5.2"
	echoContent green "描述:八合一共存脚本"
	echoContent green "微信:Falltoher-1314"
	echoContent green 博客1：https://www.kehu33.asia
	echoContent green 博客2：https://www.vcxm789.asia
 	showInstallStatus
	echoContent red "\n=============================================================="
	...
	echoContent yellow "0.卸载脚本"
	echoContent red "=============================================================="
	mkdirTools
	aliasInstall
	read -r -p "请选择:1-17或者0退出脚本" selectInstallType
