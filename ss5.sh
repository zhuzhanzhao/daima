...
menu() {
    echo -e "\t ss5 安装管理脚本 "
    echo -e "\t---authored by sldm云---"
    echo -e "\tSystem Request:Debian 9+/Ubuntu 20.04+/Centos 7+"
    echo -e "\t无法使用请联系1150315739@qq.com\n"
    echo -e "—————————————— 安装向导 ——————————————"
    echo -e "${Green} 搭建 站群多IP ss5 L2TP PPTP http 红龙wireguard ss v2ray 联系QQ1150315739${Font}"
    echo -e "${Red} QQ1150315739  ${Font}"
    echo -e "${Red} 出售美国香港多 服务器 ${Font}"
